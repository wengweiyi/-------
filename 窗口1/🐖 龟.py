...
if __name__=="__main__":
    ...
    # ==============================改娃娃头像🐖========================
    canvas_root.create_image(500, 420, image=im_root)#500  420龟  100 320丘
    # ==================================================================
    canvas_root.pack()
    ...
    while(True):
            ...
            # Label(top, text= str(var.get()) , font = ("黑体",14),fg = "red" , width = 12,height = 2).place(x = 120,y = 40,anchor = 'nw') 
    # ======================================🐖可以改字体和显示的地方=======================================================================        
            Label(top, text= '上{}N'.format(c) , font = ("黑体",180),fg = 'blue' , width = 12,height = 1).place(x=-370,y=400) #y=80
